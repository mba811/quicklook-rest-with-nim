...
TNimType NTI110012; /* TRSTNode */
TNimType NTI110006; /* TRstNodeKind */
extern TNimType NTI142; /* string */
extern TNimType NTI105; /* int */
TNimType NTI110010; /* TRstNodeSeq */
TNimType NTI110008; /* PRSTNode */
extern tgcheap40416 gch_40444;
N_NIMCALL(void, TMP109)(void* p, NI op) {
	trstnodeseq110010* a;
	NI LOC1;
	a = (trstnodeseq110010*)p;
	LOC1 = 0;
...
N_NIMCALL(trstnode110012*, newrstnode_110097)(NU8 kind) {
	...
	result = 0;
	result = (trstnode110012*) newObj((&NTI110008), sizeof(trstnode110012));
	if ((*result).Sons) nimGCunrefNoCycle((*result).Sons);
	(*result).Sons = (trstnodeseq110010*) newSeqRC1((&NTI110010), 0);
	(*result).Kind = kind;
	return result;
}
...
N_NIMCALL(void, add_110153)(trstnode110012* father, trstnode110012* son) {
	(*father).Sons = (trstnodeseq110010*) incrSeq(&((*father).Sons)->Sup, sizeof(trstnode110012*));
...
static TNimNode* TMP105[4];
static TNimNode* TMP106[65];
NI TMP108;
static char* NIM_CONST TMP107[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI110012.size = sizeof(trstnode110012);
NTI110012.kind = 18;
NTI110012.base = 0;
NTI110012.flags = 2;
TMP105[0] = &TMP23[1];
NTI110006.size = sizeof(NU8);
NTI110006.kind = 14;
NTI110006.base = 0;
NTI110006.flags = 3;
for (TMP108 = 0; TMP108 < 65; TMP108++) {
TMP23[TMP108+2].kind = 1;
TMP23[TMP108+2].offset = TMP108;
TMP23[TMP108+2].name = TMP107[TMP108];
TMP106[TMP108] = &TMP23[TMP108+2];
}
TMP23[67].len = 65; TMP23[67].kind = 2; TMP23[67].sons = &TMP106[0];
NTI110006.node = &TMP23[67];
TMP23[1].kind = 1;
TMP23[1].offset = offsetof(trstnode110012, Kind);
TMP23[1].typ = (&NTI110006);
TMP23[1].name = "kind";
TMP105[1] = &TMP23[68];
TMP23[68].kind = 1;
TMP23[68].offset = offsetof(trstnode110012, Text);
TMP23[68].typ = (&NTI142);
TMP23[68].name = "text";
TMP105[2] = &TMP23[69];
TMP23[69].kind = 1;
TMP23[69].offset = offsetof(trstnode110012, Level);
TMP23[69].typ = (&NTI105);
TMP23[69].name = "level";
TMP105[3] = &TMP23[70];
NTI110010.size = sizeof(trstnodeseq110010*);
NTI110010.kind = 24;
NTI110010.base = (&NTI110008);
NTI110010.flags = 2;
NTI110010.marker = TMP109;
TMP23[70].kind = 1;
TMP23[70].offset = offsetof(trstnode110012, Sons);
TMP23[70].typ = (&NTI110010);
TMP23[70].name = "sons";
TMP23[0].len = 4; TMP23[0].kind = 2; TMP23[0].sons = &TMP105[0];
NTI110012.node = &TMP23[0];
NTI110008.size = sizeof(trstnode110012*);
NTI110008.kind = 22;
NTI110008.base = (&NTI110012);
NTI110008.flags = 2;
NTI110008.marker = TMP110;
}
